...
export type SttProviderId = 'google' | 'groq' | 'openai' | 'deepgram' | 'elevenlabs' | 'azure' | 'ibmwatson' | 'whispr';
...
export const STT_PROVIDERS: Record<SttProviderId, SttProviderConfig> = {
    ...
    whispr: {
        id: 'whispr',
        name: 'Whispr Pro (Managed)',
        description: 'All-in-one managed STT via Whispr API',
        endpoint: '', 
        model: '',
        uploadType: 'websocket',
        authHeader: () => ({}),
