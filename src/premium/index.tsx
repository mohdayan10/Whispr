...
const _whisprApiPromo = import.meta.glob<any>(
  '../../premium/src/WhisprApiPromoToaster.tsx',
  { eager: true }
);
...
export const WhisprApiPromoToaster: React.FC<any> =
  get(_whisprApiPromo, 'WhisprApiPromoToaster', NullComponent);
