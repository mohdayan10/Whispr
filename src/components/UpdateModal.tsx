...
const UpdateModal: React.FC<UpdateModalProps> = ({
    ...
    const handleCopyCommand = () => {
        navigator.clipboard.writeText('xattr -cr /Applications/Whispr.app');
        setCopied(true);
        setTimeout(() => setCopied(false), 2000);
    };
                            ...
                            <div className="p-8 flex flex-col h-full relative text-left w-full max-w-full">
                                ...
                                <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 mb-4 space-y-2 w-full">
                                    <div className="space-y-1 w-full">
                                        ...
                                        <CopyBlock command={`xattr -cr ~/Downloads/Whispr-${displayVersion.replace('v', '')}-${instructionsArch || 'arm64'}.dmg`} />
                                    </div>
                                    <div className="space-y-1 mt-1 pl-0.5">
                                        <p className="text-[12px] font-medium text-white/80">2. Open the file and install Whispr.</p>
                                    </div>
                                    <div className="space-y-1 mt-3 w-full">
                                        ...
                                        <CopyBlock command="xattr -cr /Applications/Whispr.app" />
                                    </div>
                                </div>
