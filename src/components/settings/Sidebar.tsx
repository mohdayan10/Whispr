...
interface SidebarProps {
    activeTab: 'general' | 'whispr-api' | 'ai-providers' | 'about';
    setActiveTab: (tab: 'general' | 'whispr-api' | 'ai-providers' | 'about') => void;
    onClose: () => void;
}
        ...
        <div className="w-64 bg-bg-sidebar flex flex-col border-r border-border-subtle h-full">
            <div className="p-6">
                ...
                <nav className="space-y-1">
                    ...
                    >
                        <Zap size={16} className="text-blue-500" /> Whispr API
                    </button>
                    <button
