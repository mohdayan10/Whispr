...
export class DatabaseManager {
    ...
    private constructor() {
        ...
        this.dbPath = path.join(userDataPath, 'whispr.db');
        this.init();
    }
...
Whispr is a real-time AI meeting assistant designed to help you stay focused, informed, and fast-moving during calls. Get live insights while you speak, instant answers to questions, and structured notes after every meeting.
...
- Show or hide Whispr at any time:
  - **Mac**: Cmd + B
  - **Windows**: Ctrl + B
...
- **Usage**: Track your interaction history and see how Whispr assisted you.
...
### Undetectability
Unlock the **Undetectability** add-on to keep Whispr invisible during screen sharing.
...
**Once downloaded, return to Settings → Credentials in Whispr and select this file to complete setup.**
...
whispr.contact@gmail.com`;

        const demoMeeting: Meeting = {
            id: demoId,
            title: "Whispr Demo & Guide",
            date: today.toISOString(),
            duration: "5:00",
            summary: "Complete guide to using Whispr - your real-time AI meeting assistant.",
            detailedSummary: {
            ...
            transcript: [
                { speaker: 'interviewer', text: "Welcome to Whispr! Let me show you how it works.", timestamp: 0 },
                ...
                { speaker: 'user', text: "How do I hide Whispr during screen share?", timestamp: 60000 },
            ...
            usage: [
                { type: 'assist', timestamp: 15000, question: 'What features does Whispr have?', answer: 'Whispr offers 5 quick action buttons, screenshot analysis, real-time transcription, and comprehensive meeting notes.' },
