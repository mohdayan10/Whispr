...
export class ProcessingHelper {
  ...
  public loadStoredCredentials(): void {
    ...
    const whisprKey = credManager.getWhisprApiKey();
    if (whisprKey) {
      console.log("[ProcessingHelper] Loading stored Whispr API Key from CredentialsManager");
      this.llmHelper.setWhisprKey(whisprKey);
    }
